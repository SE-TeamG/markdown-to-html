...
public class FancyVisitor implements MDElementVisitor {
    public String htmlFileName="";
     FileWriter fw;
     BufferedWriter bw;
    FancyVisitor(String name){htmlFileName=name;}
